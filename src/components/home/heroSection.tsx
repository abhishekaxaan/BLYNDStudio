...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="relative w-full">
      ...
      {/* Full-width work showcase at the top */}
      <div className="relative w-full pt-24 pb-20">
        <div className="w-full px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 auto-rows-max max-w-7xl mx-auto">
      ...
      {/* Hero content below the work showcase */}
