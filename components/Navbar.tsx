    ...
    return (
        <nav className="fixed inset-x-0 z-50 top-6">
            <div className="mx-auto px-4 md:px-6 w-full max-w-[1800px]">
                <div
                    className="rounded-[3rem] bg-[#ebf0f5] shadow-[15px_15px_30px_#d1d9e6,-15px_-15px_30px_#ffffff] border border-white/50 transition-all duration-300"
                >
                    <div className="flex items-center justify-between px-6 md:px-12 py-5 relative z-20">
                        ...
                        <div className="hidden md:flex items-center gap-8 ml-auto">
                            ...
                            <button className="relative overflow-hidden px-6 py-3 rounded-full bg-[#ebf0f5] shadow-[6px_6px_12px_#d1d9e6,-6px_-6px_12px_#ffffff] hover:shadow-[inset_2px_2px_4px_#d1d9e6,inset_-2px_-2px_4px_#ffffff] text-brand-red font-black uppercase text-[10px] tracking-widest transition-all duration-300 border border-white/40 group">
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    ...
                    >
                        <div
                            className="w-full h-full rounded-[3rem] bg-[#ebf0f5] shadow-[24px_24px_64px_#d1d9e6,-24px_-24px_64px_#ffffff] border border-white/50 flex flex-col items-center justify-center gap-10 p-12"
                        >
                            {navItems.map((item) => (
                                <Link
                                    key={item.name}
                            ...
                            <button className="relative overflow-hidden w-full py-6 mt-6 rounded-[2rem] bg-[#ebf0f5] shadow-[10px_10px_20px_#d1d9e6,-10px_-10px_20px_#ffffff] hover:shadow-[inset_4px_4px_8px_#d1d9e6,inset_-4px_-4px_8px_#ffffff] text-brand-red font-black text-xl uppercase tracking-[0.2em] transition-all duration-300 border border-white/40 group">
                                <div className="absolute inset-0 bg-gradient-to-br from-brand-red/10 to-accent-pink/10 pointer-events-none" />
