...
export const Footer = () => {
    return (
        <footer className="w-full py-20 px-6 relative overflow-hidden bg-black border-t border-white/5">
            {/* Background elements for depth */}
            <div className="absolute inset-0 z-0 opacity-10">
                <div className="absolute top-0 right-0 w-80 h-80 bg-brand-red/10 blur-[120px] rounded-full" />
                <div className="absolute bottom-0 left-0 w-80 h-80 bg-accent-blue/10 blur-[120px] rounded-full" />
            </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
                ...
                <div>
                    <h4 className="text-sm font-bold uppercase tracking-widest text-neutral-100 mb-6">Explore</h4>
                ...
                <div>
                    <h4 className="text-sm font-bold uppercase tracking-widest text-neutral-100 mb-6">Connect</h4>
                    <ul className="flex flex-col gap-4 text-neutral-400 text-sm">
